...
export async function ensurePrivateAccountIdentity(input: {
  noodle: ReturnType<typeof createNoodleStorage>;
...
export async function tryGenerateNoodlerReaction(input: {
  noodle: ReturnType<typeof createNoodleStorage>;
  connections: ReturnType<typeof createConnectionsStorage>;
  creator: NoodleAccount;
  subscriberDisplayName: string;
        ...
        ? {
            settings: {
              ...
              ...(profileFieldsChanged
                ? { ...(avatarCrop !== undefined ? { avatarCrop } : {}), profileManuallyEdited: true }
                : {}),
            },
          }
        : {}),
